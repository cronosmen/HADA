...
// in simulator we redefine to format for Directory Developer console
...
{\
	NSString * exceptionName = [@"org.directory." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.directory";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIDirectoryNativeItemNone = -1, 
	UIDirectoryNativeItemSpinner = -2,
	UIDirectoryNativeItemProgressBar = -3,
	
	UIDirectoryNativeItemSlider = -4,
	UIDirectoryNativeItemSwitch = -5,
	UIDirectoryNativeItemMultiButton = -6,
	UIDirectoryNativeItemSegmented = -7,
	
	UIDirectoryNativeItemTextView = -8,
	UIDirectoryNativeItemTextField = -9,
	UIDirectoryNativeItemSearchBar = -10,
	
	UIDirectoryNativeItemPicker = -11,
	UIDirectoryNativeItemDatePicker = -12,
	
	UIDirectoryNativeItemInfoLight = -13,
	UIDirectoryNativeItemInfoDark = -14,
	
	UIDirectoryNativeItemDisclosure = -15,
	
	UIDirectoryNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Directory instances of
