...
/**
 Base class for all Directory views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Directory view hierarchy (such as wrapped iOS UIViews) was touched.
